...
import 'package:test_1/models/jeep_url.dart';
...
class _LocationPageState extends State<LocationPage> {
  ...
  String mapUrl = 'https://api.mapbox.com/styles/v1/kctiru/cm2c3cdhl009l01poc7xihjc7/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1Ijoia2N0aXJ1IiwiYSI6ImNtMmVhaGxnczBzMmMya3NiZTNmYmc0NGsifQ.X4OpU9Ajb6UvH4DOPneHig';

  void _onJeepneySelected(Jeepney? selectedJeepney) {
  ...
  Widget build(BuildContext context) {
    final List<Jeepney> jeepneys = jeepMap.getJeepneys();  // Get the list of jeepneys
            ...
            panel: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  JeepneyDropdown(
                    jeepneys: jeepneys,
                    onSelected: _onJeepneySelected, // Pass callback to handle selection
                  ),
            ...
            body: Stack(
              children: [
                FlutterMap(
                  ...
                  children: [
                    TileLayer(
                      urlTemplate: mapUrl, // The map URL now changes based on selection
                      maxNativeZoom: 22,
                    ),
                    LocationMarkerLayer(
